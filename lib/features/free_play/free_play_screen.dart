        ...
        child: LayoutBuilder(
          builder: (context, c) {
              ...
              children: [
                PanelCard(
                  child: Column(children: [
                    ...
                    const Text('Pluck any string to hear it',
                        style: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 6),
                    Text('No targets — just explore!', style: TextStyle(color: AppColors.textSecondary.withValues(alpha: 0.8))),
                  ]),
                ),
                const SizedBox(height: 16),
                const PanelCard(child: Center(child: Text('Ready!', style: TextStyle(color: AppColors.textSecondary)))),
                const SizedBox(height: 16),
                OutlinedButton.icon(
            ...
            return Row(
              ...
              children: [Expanded(flex: 2, child: camera), const SizedBox(width: 20), SizedBox(width: 280, child: panel)],
            );
          },
        ),
      ),
